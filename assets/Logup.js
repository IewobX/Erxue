...
filechooser.onchange = function () {
    ...
    if (!/\/(?:jpeg|jpg|png)/i.test(file.type)){
        // document.getElementById('check-file').className = '';
        document.getElementById('check-file').className = 'show';
        return;
    };
    ...
    document.getElementById('check-file').className = 'hidden';
    user.upload_pic = file;
};
...
sex.onchange = function(){
    if(sex.value == 'none'){
        document.getElementById('check-sex').className = 'show';
        return;
    }
    document.getElementById('check-sex').className = 'hidden';
...
var realnameValue = document.getElementById('realname');
realnameValue.onblur = function(){
    user.realName = realnameValue.value;
}
var ageValue = document.getElementById('age');
ageValue.onblur = function(){
    user.age = ageValue.value;
}
var descriptionValue = document.getElementById('description');
descriptionValue.onblur = function(){
    user.description = descriptionValue.value;
}
//提交
